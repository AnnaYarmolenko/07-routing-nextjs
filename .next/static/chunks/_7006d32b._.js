...
function NotePreview(param) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NotePreview.useEffect": ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchNoteById"])(id).then(setNote);
        }
    }["NotePreview.useEffect"], [
        id
    ]);
...
_s(NotePreview, "k41NuHLtMLNqVoRGkWqAFGkbS8Y=");
_c = NotePreview;
var _c;
...
;
;
function NotePreviewPage(param) {
    let { params } = param;
    _s();
...
_s(NotePreviewPage, "fN7XvhJ+p5oE6+Xlo0NJmXpxjC8=", false, function() {
    return [
...
_c = NotePreviewPage;
var _c;
__turbopack_context__.k.register(_c, "NotePreviewPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_7006d32b._.js.map